...
public:
     ...
     */
    static float tspBacktrackingAlgorithm(Graph<Station*> *graph, int src, std::vector<int>& tour, const std::vector<Station*>& stations, const std::vector<Network*>& networks);
     ...
     */
    static float tspApproximationAlgorithm(Graph<Station*> *graph, int src, std::vector<int>& tour, const std::vector<Station*>& stations, const std::vector<Network*>& networks);
     ...
     * @return The total distance of the shortest tour.
     */
    static float tspNearestNeighbor(Graph<Station*> *graph, int src, std::vector<int>& tour, const std::vector<Station*>& stations, const std::vector<Network*>& networks);
...
private:
     ...
     */
    static float calculateTotalDistance(Graph<Station*> *graph, const std::vector<int>& tour, const std::vector<Station*>& stations, const std::vector<Network*>& networks);
};
